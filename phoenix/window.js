...
const calcNewFrame = (direction, currentArea, screen) => {
  ...
  const topScreen = screens.topOf(screen).flippedVisibleFrame();
  const bottomScreen = screens.bottomOf(screen).flippedVisibleFrame();
  ...
  switch (direction) {
    ...
    case AREA.BOTTOM:
      switch (currentArea) {
        ...
        case AREA.BOTTOM:
          return FRAMES[AREA.TOP](bottomScreen);
        case AREA.BOTTOM_LEFT:
          return FRAMES[AREA.TOP_LEFT](bottomScreen);
        case AREA.BOTTOM_RIGHT:
          return FRAMES[AREA.TOP_RIGHT](bottomScreen);
        default:
          return FRAMES[AREA.BOTTOM](currentScreen);
      }
    ...
    case AREA.TOP:
      switch (currentArea) {
        case AREA.TOP:
          return FRAMES[AREA.BOTTOM](topScreen);
        case AREA.TOP_LEFT:
          return FRAMES[AREA.BOTTOM_LEFT](topScreen);
        case AREA.TOP_RIGHT:
          return FRAMES[AREA.BOTTOM_RIGHT](topScreen);
        case AREA.LEFT:
          return FRAMES[AREA.TOP_LEFT](currentScreen);
        case AREA.BOTTOM_LEFT:
          return FRAMES[AREA.LEFT](currentScreen);
